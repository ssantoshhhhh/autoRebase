...
export default function TrackingPage() {
  ...
  const statusStyle = complaint ? STATUS_COLORS[complaint.status] || STATUS_COLORS.FILED : {};
  ...
  return (
    ...
    >
      <div style={{ maxWidth: '640px', margin: '0 auto' }}>
        <h1 style={{ marginBottom: '8px', fontSize: '1.75rem' }}>Track Complaint</h1>
        <p
          style={{
          ...
          <div style={{ animation: 'fadeIn 0.4s ease' }}>
            ...
            <div className="card" style={{ marginBottom: '16px' }}>
              ...
              <div style={{ display: 'grid', gap: '12px', fontSize: '0.9rem' }}>
                <Row label="Incident Type" value={complaint.incidentType || 'General'} />
            ...
            {complaint.updates?.length > 0 && (
              <div className="card">
                <h4 style={{ marginBottom: '16px', fontSize: '1rem' }}>Activity Timeline</h4>
