...
router.post('/submit', authenticateUser, async (req, res, next) => {
  try {
    ...
    // AI-generated summary logic removed (since ai-service is being deleted)
    const aiSummary = {
    ...
    const complaint = await prisma.complaint.create({
      data: {
        ...
        priorityLevel: aiSummary.priorityLevel || 'INFORMATIONAL',
        priorityScore: aiSummary.priorityScore || 0,
        isEmergency: aiSummary.isEmergency || false,
        incidentType: aiSummary.incidentType || 'General',
        summaryText: aiSummary.summary,
        structuredJson: aiSummary.structuredData || structuredJson,
        transcript,
